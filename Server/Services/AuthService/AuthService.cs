...
namespace BlazorECommerceDemo.Server.Services.AuthService
{
    public class AuthService : IAuthService
    {
        ...
        public int GetUserId() => int.Parse(_httpContextAccessor.HttpContext.User.FindFirstValue(ClaimTypes.NameIdentifier) ?? "-1");
