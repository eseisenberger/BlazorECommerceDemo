using Azure;
using BlazorECommerceDemo.Client.Pages;
using BlazorECommerceDemo.Client.Services.AuthService;
using BlazorECommerceDemo.Shared;
using Blazored.LocalStorage;

namespace BlazorECommerceDemo.Client.Services.CartService
{
    public class CartService : ICartService
    {
        ...
        private async Task SetCartAsync(List<CartItem> cart)
        {
